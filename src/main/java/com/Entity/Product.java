...
//if udhar se oneToMany Ho raha hai to idhar se ManyToOne Hoga
@ManyToOne
...
//Category ka geytter and setter
...
///Yaha discount ki calculation karo ki web me minus kr k kitna discount dikhayega

public int getPriceAfterApplyDiscount() {
	
	int d=(int)((this.getpDiscount()/100.0) * this.getpPrice());
	 
	//and now minus kr dege original ko discount sse and then return kr dege
